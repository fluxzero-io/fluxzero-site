...
function fixture() {
    return {pages:new Map([['/',inspectPage(`<link rel="canonical" href="${site}/"><a href="/proof">Proof</a>`,'/')],['/proof/',inspectPage(`<link rel="canonical" href="${site}/proof/"><a href="/">Home</a>`,'/proof/')]]),sitemap:new Set(['/','/proof/']),llms:`[Home](${site}/) [Proof](${site}/proof/)`,full:`[Home](${site}/) [Proof](${site}/proof/)`,robots:`Sitemap: ${site}/sitemap-index.xml`};
}
