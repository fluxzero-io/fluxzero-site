...
1. Get the Fluxzero CLI
   ...
   <Tabs>
      <TabItem label="Bash">
         ```shell
            curl -o- -s -L https://github.com/fluxzero-io/flux-cli/releases/latest/download/install.sh | bash
         ```
      ...
      <TabItem label="Manually">
         ...
         1. Download the latest [flux-cli.jar](https://github.com/fluxzero-io/flux-cli/releases/latest/download/flux-cli.jar)
