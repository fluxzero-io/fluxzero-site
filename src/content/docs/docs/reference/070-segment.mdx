...
- **[Routing Keys](/docs/reference/065-routing-key)** - How messages are assigned to specific segments
- **[Handlers](/docs/reference/030-handler)** - Processing components that run within segments
- **[Aggregates](/docs/reference/005-aggregate)** - How entity IDs automatically provide segment routing
- **[Message Log](/docs/reference/032-message-log)** - Storage system that segments read messages from
- **[Commands](/docs/reference/010-command)** - Messages that are distributed across segments for processing
- **[Events](/docs/reference/025-event)** - Messages processed by segments to maintain consistency
- **[Tracker](/docs/reference/081-tracker)** - Components that manage segment assignment and processing
