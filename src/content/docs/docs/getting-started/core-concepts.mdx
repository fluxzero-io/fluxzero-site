...
<Aside type="note">
    ...
    In previous examples, such as with queries, we didn't need to register anything manually because the query class itself contained the handler, allowing Fluxzero to [automatically discover it](/docs/guides/configuration--support/310-configuring-fluxzero/#spring-auto-configuration).
    ...
    See [Configuring Fluxzero](/docs/guides/configuration--support/310-configuring-fluxzero/) for more details.
</Aside>
