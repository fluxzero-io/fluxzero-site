...
A **tracker** is a lightweight worker thread that continuously fetches messages from the Fluxzero Runtime and dispatches them to your handlers for a specific [consumer](/docs/reference/020-consumer).
