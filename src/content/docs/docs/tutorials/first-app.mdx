...
- **DeleteTask**: removes an unresolved task.
...
To delete a task, simply return `null` from your `@Apply` method:

<Tabs>
<TabItem value="Java" label="Java">

```java
// src/main/java/io/fluxzero/todo/project/command/DeleteTask.java
public record DeleteTask(ProjectId projectId,
                         @NotNull TaskId taskId) implements TaskUpdate {
...
```kotlin
// src/main/kotlin/io/fluxzero/todo/project/command/DeleteTask.kt
