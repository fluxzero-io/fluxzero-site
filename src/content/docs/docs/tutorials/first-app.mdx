...
<Aside type="note">
  ...
  [Message tracking](/docs/guides/messaging/message-tracking/).
</Aside>
...
Want to understand why we recommend reusing the same payload in both command and event? See [Applying entity updates](/docs/guides/modeling-and-persistence/domain-modeling#applying-updates-to-entities).
...
<Aside type="note">
  ...
  For more information on injecting application properties, [see here](/docs/guides/configuration-and-support/application-properties/).
</Aside>
...
- Dive deeper with our [developer guides](/docs/guides)
